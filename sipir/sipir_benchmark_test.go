...
var (
	...
	batchSize      uint64
	batchtype      string
	sipirID        string // piano 0, singlepass 1, singleserver 2
)
...
func BenchmarkSkip(b *testing.B) {
	...
	fmt.Printf("SIPIR Evaluation Results (N=2^%d, uint64PerEntry=%d, Batch=%d)\n", logNumEntries, uint64PerEntry, batchSize)
