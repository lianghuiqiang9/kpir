...
# Piano
go test -bench=BenchmarkSkip -benchmem -run=none -v -timeout 0 -args -logN=20 -bitsPerEntry=32 -batch=1 -type="skip" -pirID="piano"
go test -bench=BenchmarkSkip -benchmem -run=none -v -timeout 0 -args -logN=25 -bitsPerEntry=32 -batch=1 -type="skip" -pirID="piano"

# SinglePass
go test -bench=BenchmarkRewind -benchmem -run=none -v -timeout 0 -args -logN=20 -bitsPerEntry=32 -batch=1 -type="rewind" -pirID="singlepass"
...
# SingleServer
go test -bench=BenchmarkRewind -benchmem -run=none -v -timeout 0 -args -logN=20 -bitsPerEntry=32 -batch=1 -type="rewind" -pirID="singleserver"
...
# Piano with Skip
go test -bench=BenchmarkSkip -benchmem -run=none -v -timeout 0 -args -logN=20 -bitsPerEntry=32 -batch=3 -type="skip" -pirID="piano"
go test -bench=BenchmarkSkip -benchmem -run=none -v -timeout 0 -args -logN=25 -bitsPerEntry=32 -batch=3 -type="skip" -pirID="piano"

# Piano with Rewind
go test -bench=BenchmarkRewind -benchmem -run=none -v -timeout 0 -args -logN=20 -bitsPerEntry=32 -batch=3 -type="rewind" -pirID="piano"
...
go test -bench=BenchmarkRewind -benchmem -run=none -v -timeout 0 -args -logN=20 -bitsPerEntry=32 -batch=3 -type="rewind" -pirID="singlepass"
...
go test -bench=BenchmarkRewind -benchmem -run=none -v -timeout 0 -args -logN=20 -bitsPerEntry=32 -batch=3 -type="rewind" -pirID="singleserver"
